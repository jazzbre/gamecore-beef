...
namespace GameCore
{
	...
	public class Model : Resource
	{
		...
		public void Render(RenderCommandBuffer commandBuffer, Matrix4 _worldMatrix, Shader shader, Vector4 color = .One, Vector4 settings = .Zero, GpuTexture[] textureHandles = null, RenderState? state = null, SamplerDesc? sampler = null, int programIndex = 0, bool useSH = false)
		{
            ...
            for (var group in Mesh.Groups)
            {
                ...
                RenderManager.Draw(commandBuffer, shader, programIndex, group.m_vbh, group.m_ibh, group.m_numVertices, group.m_numIndices,
