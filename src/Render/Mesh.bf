...
namespace GameCore
{
    ...
    class Mesh
    {
        ...
        public void Render(RenderCommandBuffer commandBuffer, Matrix4 worldMatrix, Shader shader, GpuTexture[] textureHandles, Color color = Color.White, RenderState? state = null, SamplerDesc? sampler = null, int programIndex = 0, Span<uint8> parameters = default)
        {
