...
namespace GameCore
{
	...
	class Mesh3D
	{
		...
		public void Render(uint16 viewId, Matrix4 worldMatrix, Shader shader, GpuTexture[] textureHandles, Color color = Color.White, RenderState? state = null, SamplerDesc? sampler = null, int programIndex = 0, Camera camera = null)
		{
            ...
            if (camera != null) renderState.Depth.depth_compare = camera.DepthTest;
