...
namespace Dedkeni
{
	struct SHA256Hash
	{
		...
		{
#unwarn
			System.Security.Cryptography.HashEncode.HashEncode64(((uint64*)&mHash)[0], outStr);
#unwarn
			System.Security.Cryptography.HashEncode.HashEncode64(((uint64*)&mHash)[1], outStr);
#unwarn
			System.Security.Cryptography.HashEncode.HashEncode64(((uint64*)&mHash)[2], outStr);
#unwarn
			System.Security.Cryptography.HashEncode.HashEncode64(((uint64*)&mHash)[3], outStr);
		}
	}
